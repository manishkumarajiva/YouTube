...
const router = Router();
import { UploadChannelVideo, GetChannelVideo, GetVideoById, UpdateVideoInfo, UpdateVideoThumbnail } from "../../../controllers/video.controller.js";
...
router.put("/thumbnail", upload.single("thumbnail"), UpdateVideoThumbnail);
